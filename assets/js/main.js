...
let camilaSaTexto =
  "Camila Sá é fotógrafa desde os 16 anos, portovelhense e educadora. Sua produção transita entre a fotografia e a\n" +
...
let joaoVictorTexto =
  "João Victor artista visual e educomunicador em trânsito constante entre linguagens, tem seus trabalhos voltados à\n" +
...
let mariaTexto =
  "Maria Silper é natural de Porto Velho,\n" +
...
let samaraTexto =
  "Samara Ramos é natural de Comodoro – MT, é\n" +
...
function openModalArtistas(artista, texto) {
  ...
  window.onload = loadPage; // sem parênteses!
